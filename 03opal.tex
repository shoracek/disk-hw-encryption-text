...
\item \verb|ACTIVATE_LSP| command changes state from Manufactured-Inactive to Manufactured state, enabling its usage. Additionally, it can also facilitate the setup of Single User Mode. \todo[color=green]{write about TPer states in the generic chapter. }
