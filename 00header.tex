...
\thesissetup{
    ...
    keywords    = {disk encryption, self-encrypting drive, Linux, storage security},
    % TeXkeywords = {keyword1, keyword2, \ldots},
    abstract    = {%

% The eXpress Data Path is still a quite young technology, and as such, its testing environment may prove insufficient. Existing test suites may require duplicated code, and yet be too specific to cover multiple use cases.
% This work introduces test suite, with a test harness providing functionality to solve this problem and several test cases testing the basic capabilities of the eXpress Data Path.
...
This work looks at the security of such technologies, focusing on the popular Opal standard. In order to be able to understand the problematics more deeply, this work also implements a set of tools to manage and analyse Opal devices.
